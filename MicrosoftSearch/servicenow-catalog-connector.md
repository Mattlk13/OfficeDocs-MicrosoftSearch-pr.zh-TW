...
如果您觀察到套用至搜尋結果的存取權限不一致，請確認將使用者準則套用 [至目錄專案中的使用者準則設定](https://docs.servicenow.com/bundle/orlando-it-service-management/page/product/service-catalog-management/task/t_AppUserCritItemsCat.html)。
